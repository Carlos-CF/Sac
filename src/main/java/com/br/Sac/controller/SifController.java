...
public class SifController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Criado (Created)", content = {
                    @Content(mediaType = "application/json", schema = @Schema(implementation = SifDTO.class))}),
    ...
    public ResponseEntity<Object> cadastrar(@RequestBody SifDTO objeto) throws Exception {
        return sifService.cadastrar(objeto);
    }
    ...
    public ResponseEntity<Object> listarPorId(@PathVariable Long idObjeto) throws Exception {
        return sifService.listarPorId(idObjeto);
    }
    ...
    public ResponseEntity<Object> editar(@PathVariable Long idObjeto, @RequestBody SifDTO objeto) throws Exception {
        return sifService.editar(idObjeto, objeto);
    }
    ...
    public ResponseEntity<Object> excluir(@PathVariable Long idObjeto) throws Exception {
        return sifService.excluir(idObjeto);
    }
}
