...
public class SetorController {
    ...
    public ResponseEntity<Object> cadastrar(@RequestBody SetorDTO objeto) throws Exception {
        return setorService.cadastrar(objeto);
    }
    ...
    public ResponseEntity<Object> listarPorId(@PathVariable Long idObjeto) throws Exception {
        return setorService.listarPorId(idObjeto);
    }
    ...
    public ResponseEntity<Object> editar(@PathVariable Long idObjeto, @RequestBody SetorDTO objeto) throws Exception {
        return setorService.editar(idObjeto, objeto);
    }
    ...
    public ResponseEntity<Object> excluir(@PathVariable Long idObjeto) throws Exception {
        return setorService.excluir(idObjeto);
    }
    ...
    public ResponseEntity<Object> mudarStatus(@PathVariable Long idObjeto) throws Exception {
        return setorService.mudarStatus(idObjeto);
    }
}
